...
def train(args):
    ...
    labels = list(labels) #added by me
    #print("In classifier.py, shape of list(labels) :")#added by me
    #print(np.shape(list(labels)))#added by me
    #raghu = list(labels)
    #print(raghu)
    #le = LabelEncoder().fit(raghu) 
    ...
    print("le : {}; type: {}".format(le, type(le)))
    print("clf : {}; type: {}".format(clf, type(clf)))
